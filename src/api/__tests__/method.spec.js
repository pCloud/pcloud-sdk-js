...
describe('ApiMethod', () => {
  it('correctly passes the params and calls the success callback', async () => {
    var query;
    superMockery(/listfolder/, mockResponse(mockReturnListfolder), (q) => { query = q; });
  ...
  it('returns error when folder is dummy', async () => {
    var query;
    superMockery(/listfolder/, mockResponse(mockReturnListfolderError), (q) => { query = q; });
  ...
  it('responseType == text', async () => {
    var query;
    superMockery(/getthumbs/, "text result", (q) => { query = q; });
